...
- **Enables:** Flask session cookie forgery (FV-03). An attacker who knows
  ...
  login entirely.
- **Severity note:** The literal value `***REMOVED***` is what every credential
...
|---|---------------------|------------------------------------|---------|------------|-----------------------|
| 1 | AWS_ACCESS_KEY_ID   | ***REMOVED***               | ✅      | ❌         | IV-04                 |
| 2 | AWS_SECRET_ACCESS_KEY | wJalrXUtnFEMI/K7MDENG/bP...      | ✅      | ❌         | IV-04                 |
| 3 | JWT secret          | ***REMOVED***               | ✅      | ✅         | IV-03, IV-04, AV-07   |
| 4 | SESSION_SECRET      | ***REMOVED***                           | ✅      | ✅         | IV-03, IV-04, FV-03   |
| 5 | auth-db password    | ***REMOVED***                        | ❌      | ✅         | IV-01, IV-03          |
| 6 | transaction-db pwd  | ***REMOVED***                          | ❌      | ✅         | IV-01, IV-03          |
