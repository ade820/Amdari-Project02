...
|---------|------|------|----------|---------------|-------|
| AWS_ACCESS_KEY_ID (AKIAIOSFODNN7EXAMPLE) | .env | 6 | CRITICAL | IV-04 | DevSecOps |
| AWS_SECRET_ACCESS_KEY (wJalrXUtnFEM...) | .env | 7 | CRITICAL | IV-04 | DevSecOps |
| SECRET_KEY=super-secret-key-123 | .env | 11 | CRITICAL | IV-04, AV-07 | DevSecOps + AppSec |
| SESSION_SECRET=changeme | .env | 12 | CRITICAL | IV-04, FV-03 | DevSecOps + AppSec |
| DB_PASSWORD=securepassword123 | .env | 15 | CRITICAL | IV-04 | DevSecOps |
| POSTGRES_PASSWORD=securepassword123 | .env | 16 | CRITICAL | IV-04 | DevSecOps |
| SONAR_TOKEN=squ_a1b2... | .env | 19 | CRITICAL | IV-04 | DevSecOps |
| POSTGRES_PASSWORD=authpass123 | docker-compose.yml | 18 | CRITICAL | IV-01, IV-03 | DevSecOps |
| POSTGRES_PASSWORD=txpass123 | docker-compose.yml | 30 | CRITICAL | IV-01, IV-03 | DevSecOps |
| DB_PASSWORD=authpass123 | docker-compose.yml | 44 | CRITICAL | IV-01, IV-03 | DevSecOps |
| JWT_SECRET=super-secret-key-123 | docker-compose.yml | 45 | CRITICAL | AV-07, IV-03 | DevSecOps + AppSec |
| DB_PASSWORD=txpass123 | docker-compose.yml | 58 | CRITICAL | IV-01, IV-03 | DevSecOps |
| SESSION_SECRET=changeme | docker-compose.yml | 69 | CRITICAL | FV-03, IV-03 | DevSecOps + AppSec |
| JWT_SECRET="super-secret-key-123" | infra/kubernetes/base/configmap.yaml | 9 | CRITICAL | CK-09 | DevSecOps |
| SESSION_SECRET="changeme" | infra/kubernetes/base/configmap.yaml | 10 | CRITICAL | CK-09 | DevSecOps |
| AUTH_DB_PASSWORD="authpass123" | infra/kubernetes/base/configmap.yaml | 11 | CRITICAL | CK-09 | DevSecOps |
| TX_DB_PASSWORD="txpass123" | infra/kubernetes/base/configmap.yaml | 12 | CRITICAL | CK-09 | DevSecOps |
